...
class CityPolicy
{
    ...
    {
        //
        return $admin->hasPermissionTo('Create-Cities');
    }
    ...
    public function update(Admin $admin, City $city)
    {
        ...
        Response::allow() : Response::deny('You have no Permissions') ;
    }
    ...
    public function delete(Admin $admin, City $city)
    {
        ...
        ? Response::allow() : Response::deny('Sorry , You Have No Permission !!');
    }
