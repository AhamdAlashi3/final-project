...
@section('page-name', 'Create Doctor')
@section('main-page', 'Doctor')
@section('sub-page', 'Create Doctor')
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="doctor-image">
                ...
                @section('scripts')
                    ...
                    <script>
                        function store() {
                            ...
                            // formData.append('image', document.getElementById('doctor-image').files[0]);

                            if (document.getElementById('doctor-image').files[0] != undefined) {
                                formData.append('image', document.getElementById('doctor-image').files[0]);
                            }
                            ...
                            axios.post('/cms/admin/doctor', formData)
                                //  {
